      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="font-cormorant text-lg text-white tracking-wide">Where Beauty Meets Artistry</span>
          ...
          <p className="font-montserrat text-lg sm:text-xl md:text-2xl text-white/95 mb-8 max-w-3xl mx-auto leading-relaxed text-pretty">
            Experience the pinnacle of luxury beauty treatments in our serene sanctuary. From exquisite nail artistry to
            rejuvenating spa experiences, we craft moments of pure indulgence.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button
              asChild
              size="lg"
              className="bg-rose-gold hover:bg-soft-gold text-white font-montserrat px-8 py-4 rounded-full text-lg luxury-shadow transition-all duration-300 hover:scale-105"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-white/90">
            <div className="flex items-center">
              <div className="font-playfair text-2xl font-bold text-rose-gold mr-2">500+</div>
              <div className="font-montserrat text-sm">Happy Clients</div>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/30"></div>
            <div className="flex items-center">
              <div className="font-playfair text-2xl font-bold text-rose-gold mr-2">5★</div>
              <div className="font-montserrat text-sm">Premium Rating</div>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/30"></div>
            <div className="flex items-center">
              <div className="font-playfair text-2xl font-bold text-rose-gold mr-2">3+</div>
              <div className="font-montserrat text-sm">Years Excellence</div>
            </div>
          </div>
        </div>
      </div>
