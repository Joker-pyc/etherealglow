  ...
  return (
    <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/luxury-salon-interior.png" alt="Book Your Appointment" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="font-montserrat text-xl md:text-2xl text-cream max-w-3xl mx-auto leading-relaxed text-pretty">
            Reserve your appointment and step into a world of luxury and transformation
          </p>
        </motion.div>
      </div>
    </section>
